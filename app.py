...
def cart():
    ...
    if request.args:
        ...
        sql_insert = "INSERT INTO D0018E.Item ({0}) VALUES ({1}, (SELECT CaID FROM D0018E.Cart WHERE CaID = {2}), (SELECT CaID FROM D0018E.Product WHERE PID = {3}), {4}".format(keys, str(IID), CaID, data[0], data[1])
        execute(sql_insert, False)
