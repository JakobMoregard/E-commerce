...
def adminForm():
    ...
    if req['form_id'] == '1':
        ...
        try:
            sql = "DELETE D0018E.Product.*, D0018E.Available.* FROM D0018E.Product INNER JOIN D0018E.Available ON D0018E.Product.PID = D0018E.Available.PrID WHERE D0018E.Product.PID = {};".format(req['PID'])
